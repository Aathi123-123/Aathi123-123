<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Ahammed%20Aathif&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Cybersecurity%20Engineer%20%7C%20Ethical%20Hacker%20%7C%20Bug%20Bounty%20Hunter&descAlignY=62&descSize=16" width="100%"/>

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=3000&pause=1000&color=70A5FD&center=true&vCenter=true&width=750&lines=Cybersecurity+Engineering+Student+%F0%9F%94%90;Ethical+Hacker+%7C+Bug+Bounty+Hunter+%F0%9F%90%9B;Secure+Software+Developer+%7C+Flutter+%26+Python;Research+%7C+Penetration+Testing+%7C+CTFs)](https://git.io/typing-svg)
...
- 🔭 Working on **Secure Software & Vulnerability Research**
...
![OpenVAS](https://img.shields.io/badge/OpenVAS-67AB9F?style=flat-square&logo=greenbone&logoColor=white)
...
<details>
<summary><b>ED xcellence</b> &nbsp;|&nbsp; Cybersecurity Intern &nbsp;|&nbsp; 2024 &nbsp;|&nbsp; India</summary>
...
- 🔍 Assisted in hands-on **vulnerability assessments** using industry-standard security tools
- 🛡️ Participated in **cybersecurity awareness programs** and practical security activities
- 🧰 Gained real-world experience with tools like **Nmap, Wireshark, and OpenVAS**
- 📚 Applied theoretical cybersecurity concepts to live operational scenarios
...
| 🏆 | Achievement |
|----|-------------|
| 🎓 | **Cisco Ethical Hacker** – Certified in ethical hacking methodologies & penetration testing |
| 🌐 | **Cisco Networking Certification** – Certified in networking fundamentals and protocols |
| 🔐 | **Google Cybersecurity Professional Certificate** – Completed full Google cybersecurity career path |
| 🤖 | **IBM Cybersecurity Certifications** – Multiple IBM-certified cybersecurity credentials |
| 📜 | **HackerRank & Coursera Certifications** – Industry-recognized skill validations |
| 🔬 | **Research Contributor** – NeuroBridge: Adaptive Assistive Software Framework (Human-Environment Interaction) |
| 🐛 | **Bug Bounty Enthusiast** – Actively hunting vulnerabilities through ethical hacking practices |
| 📱 | **4+ Projects Shipped** – Across cybersecurity, mobile, web, and automation domains |
...
|--------|------------|----------|--------|
| 🔐 B.Tech – Cybersecurity Engineering | Jain (Deemed-to-be) University | Bangalore, India | Pursuing |
| 📚 Higher Secondary Education | MES Raja Residential School | Calicut, Kerala | Completed |
| 🏫 High School | Modern International School | Saudi Arabia | Completed |
...
```
Advanced Penetration Testing  ->  Web App Pentesting, API Security, OWASP Top 10
Bug Bounty Hunting            ->  Recon Techniques, Burp Suite Pro, HackerOne Workflow
Malware Analysis              ->  Static Analysis, Reverse Engineering, PE Headers
Cloud Security                ->  AWS IAM, Cloud Misconfigurations, CSPM Tools
CTF Challenges                ->  Pwn, Forensics, Cryptography, Web Exploitation
AI in Cybersecurity           ->  LLM Security, Prompt Injection, AI-Assisted Recon
```
